  ...
  return (
    <div className="flex flex-col  items-center w-full min-h-screen ">
        ...
        <div className="carousel-wrapper w-[80%] h-auto ">
            ...
            <span id="item-4"></span>
            <span id="item-5"></span>
            <div className="flex flex-col justify-center h-[70vh] items-center carousel-item rounded-lg item-1 shadow-lg">
            ...
            <div className="flex flex-col justify-center h-[70vh] items-center carousel-item rounded-lg item-2 shadow-lg">
                <img className="h-15 w-auto" src="https://res.cloudinary.com/dbhtt5ozr/image/upload/v1682116457/samples/cloudinary-logo-vector.svg" alt="" />
                <div className="flex flex-col justify-between items-center gap-2">
            ...
            {/* ITEM OPEN */}
            <div className="flex flex-col justify-center h-[70vh] items-center carousel-item rounded-lg item-3 shadow-lg">
                <img className="h-15 w-auto" src="https://res.cloudinary.com/dbhtt5ozr/image/upload/v1682116457/samples/cloudinary-logo-vector.svg" alt="" />
                <div className="flex flex-col justify-between items-center gap-2">
            ...
            {/* ITEM OPEN */}
            <div className="flex flex-col justify-center h-[70vh] items-center carousel-item rounded-lg item-4 shadow-lg">
                <img className="h-15 w-auto" src="https://res.cloudinary.com/dbhtt5ozr/image/upload/v1682116457/samples/cloudinary-logo-vector.svg" alt="" />
                <div className="flex flex-col justify-between items-center gap-2">
            ...
            {/* ITEM OPEN */}
            <div className="flex flex-col justify-center h-[70vh] items-center carousel-item rounded-lg item-5 shadow-lg">
                <img className="h-15 w-auto" src="https://res.cloudinary.com/dbhtt5ozr/image/upload/v1682116457/samples/cloudinary-logo-vector.svg" alt="" />
                <div className="flex flex-col justify-between items-center gap-2">
